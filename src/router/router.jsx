...
const CreateFaceRecognitionPage = lazy(() =>
  import(
    "../page/FaceRecognitionPage/CreateFaceRecognition/create_face_recognition"
  )
);
const LoginFaceRecognitionPage = lazy(() =>
  import(
    "../page/FaceRecognitionPage/LoginFaceRecognition/login_face_recognition"
  )
);
const ForgotPasswordPage = lazy(() =>
  import("../page/ForgotPassword/forgot_password")
);
const CreateGroupPage = lazy(() =>
  import("../page/GroupPage/CreateGroup/create_group")
);
const EditInfoGroupPage = lazy(() =>
  import("../page/GroupPage/EditInfoGroup/edit_info_group")
);
const GroupAdminPage = lazy(() =>
  import("../page/GroupPage/GroupAdmin/group_admin")
);
const GroupAdminMemberPage = lazy(() =>
  import("../page/GroupPage/GroupAdminMember/group_admin_member")
);
const GroupHomePage = lazy(() =>
  import("../page/GroupPage/GroupHome/group_home")
);
const GroupMemberPage = lazy(() =>
  import("../page/GroupPage/GroupMember/group_member")
);
const ListPostGroupPage = lazy(() =>
  import("../page/GroupPage/ListPostGroup/list_post_group")
);
const HomePage = lazy(() => import("../page/Home/home_page"));
const LoginPage = lazy(() => import("../page/LoginPage/login_page"));
const CreateProductPage = lazy(() =>
  import("../page/MarketplacePage/MarketplaceCreate/marketplace_create")
);
const MarketplaceDetail = lazy(() =>
  import("../page/MarketplacePage/MarketplaceDetail/marketplace_detail")
);
const EditProductPage = lazy(() =>
  import("../page/MarketplacePage/MarketplaceEdit/marketplace_edit")
);
const MarketplaceSearchPage = lazy(() =>
  import("../page/MarketplacePage/MarketplaceSearch/marketplace_search")
);
const PostDetail = lazy(() =>
  import("../page/PostPage/PostDetail/post_detail")
);
const EditPost = lazy(() => import("../page/PostPage/PostEdit/post_edit"));
const ProfileEditor = lazy(() =>
  import("../page/ProfilePage/ProfileEditor/profile_editor")
);
const ProfileFriend = lazy(() =>
  import("../page/ProfilePage/ProfileFriends/profile_friends")
);
const ProfileGroup = lazy(() =>
  import("../page/ProfilePage/ProfileGroup/profile_group")
);
const ProfilePage = lazy(() =>
  import("../page/ProfilePage/ProfileHome/profile_page")
);
const ProfileImage = lazy(() =>
  import("../page/ProfilePage/ProfileImage/profile_image")
);
const ProfileLiked = lazy(() =>
  import("../page/ProfilePage/ProfileLiked/profile_liked")
);
const ProfileRequest = lazy(() =>
  import("../page/ProfilePage/ProfileRequest/profile_request")
);
const ProfileStoreStory = lazy(() =>
  import("../page/ProfilePage/ProfileStoreStory/profile_store_story")
);
...
const CreateStoryImagePreview = lazy(() =>
  import(
    "../page/StoriesPage/CreateStoryPage/CreateStoryImagePreview/create_story_image_preview"
  )
);
const CreateStoryTextPreview = lazy(() =>
  import(
    "../page/StoriesPage/CreateStoryPage/CreateStoryTextPreview/create_story_text_preview"
  )
);
const CreateStoryPage = lazy(() =>
  import("../page/StoriesPage/CreateStoryPage/create_story_page")
);
...
const routes = [
  ...
  },
  {
    ...
    requireAuth: false,
    component: (
      <LoginFaceRecognitionPage titlePage="Đăng nhập Nhận diện khuôn mặt | Vibe" />
    ),
  },
  {
    path: "/login",
  ...
  },
  {
    ...
    requireAuth: true,
    component: (
      <CreateFaceRecognitionPage titlePage="Tạo Nhận diện khuôn mặt | Vibe" />
    ),
  },
  {
  ...
  },
  {
    ...
    requireAuth: true,
    component: (
      <VideoCall isVideoCall={false} titlePage="Cuộc gọi thoại | Vibe" />
    ),
  },
  {
    path: "/search",
